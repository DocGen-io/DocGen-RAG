...
from .filesAnalyzerPrompt import file_analyzer_system_prompt, file_analyzer_user_prompt
from .fetchExamplePrompt import fetch_example_system_prompt, fetch_example_user_prompt

# Backward-compatible aliases (for existing tests that access .template)
from string import Template as _Template
doc_creator_prompt = _Template(doc_creator_system_prompt)
file_analyzer_prompt = _Template(file_analyzer_system_prompt)
